...
const translations = {
  pt: {
    ...
    // Tour Detail Content
    'tourDetail.aboutTour': 'Sobre Este Tour',
    'tourDetail.highlights': 'Destaques do Tour',
    'tourDetail.routeMap': 'Mapa do Percurso',
    'tourDetail.routeDisclaimer': '* Percurso sujeito a alterações conforme preferências do cliente',
    'tourDetail.detailedItinerary': 'Itinerário Detalhado',
    'tourDetail.viewAllPlaces': 'Ver Todos os Lugares',
    'tourDetail.viewLess': 'Ver Menos',
    'tourDetail.included': 'O que está incluído',
    'tourDetail.notIncluded': 'O que não está incluído',
    'tourDetail.importantInfo': 'Informações Importantes',
    'tourDetail.from': 'A partir de',
    'tourDetail.perPerson4': 'por pessoa (4 pessoas)',
    'tourDetail.numberOfPassengers': 'Número de Passageiros',
    'tourDetail.person': 'pessoa',
    'tourDetail.people': 'pessoas',
    'tourDetail.perPerson': 'por pessoa',
    'tourDetail.bookNow': 'Reservar Agora',
    'tourDetail.whatsapp': 'WhatsApp',
    'tourDetail.whatsappMessage': 'Olá! Gostaria de mais informações sobre o tour:',
    'tourDetail.needHelp': 'Precisa de Ajuda?',
    'tourDetail.ourGuarantees': 'Nossas Garantias',
    'tourDetail.fullInsurance': 'Seguro Completo',
    'tourDetail.insuranceDesc': 'Acidentes e responsabilidade civil',
    'tourDetail.premiumVehicles': 'Veículos Premium',
    'tourDetail.vehiclesDesc': 'Hyundai & Toyota',
    'tourDetail.certifiedDriver': 'Motorista Certificado',
    'tourDetail.certifiedDriverDesc': 'Profissional licenciado',
    
    // Tour Detail Important Info
    'tourDetail.info.reservations': 'Reservas são obrigatórias com pelo menos 24 horas de antecedência',
    'tourDetail.info.weather': 'Tours funcionam independentemente das condições meteorológicas',
    'tourDetail.info.flexible': 'Itinerário pode ser ajustado conforme suas preferências',
    'tourDetail.info.pickup': 'Recolha e entrega no local designado por si',
    ...
    // Validation Messages
    'booking.validation.nameMin': 'O nome deve ter pelo menos 2 caracteres',
    ...
    'faq.subtitle': 'Encontre respostas para as questões mais comuns sobre os nossos tours privados',
    'faq.stillHaveQuestions': 'Ainda tem questões?',
    'faq.contactMessage': 'Estamos aqui para ajudar! Contacte-nos e responderemos a todas as suas dúvidas.',
    ...
    'footer.insuranceDesc': 'Acidentes e responsabilidade incluídos',
  ...
  en: {
    ...
    // Hero Section
    'hero.title': 'Discover Portugal in an',
    'hero.titleHighlight': 'Exclusive Way',
    'hero.subtitle': 'Customized private tours. Unique experiences from Lisbon to the most charming corners of Portugal.',
    ...
    'tourDetail.routeMap': 'Route Map',
    'tourDetail.routeDisclaimer': '* Route subject to changes according to client preferences',
    'tourDetail.detailedItinerary': 'Detailed Itinerary',
    'tourDetail.viewAllPlaces': 'View All Places',
    'tourDetail.viewLess': 'View Less',
    'tourDetail.included': 'What\'s included',
    'tourDetail.notIncluded': 'What\'s not included',
    'tourDetail.importantInfo': 'Important Information',
    'tourDetail.from': 'From',
    'tourDetail.perPerson4': 'per person (4 people)',
    'tourDetail.numberOfPassengers': 'Number of Passengers',
    'tourDetail.person': 'person',
    'tourDetail.people': 'people',
    'tourDetail.perPerson': 'per person',
    'tourDetail.bookNow': 'Book Now',
    'tourDetail.whatsapp': 'WhatsApp',
    'tourDetail.whatsappMessage': 'Hello! I would like more information about the tour:',
    'tourDetail.needHelp': 'Need Help?',
    'tourDetail.ourGuarantees': 'Our Guarantees',
    'tourDetail.fullInsurance': 'Full Insurance',
    'tourDetail.insuranceDesc': 'Accidents and liability',
    'tourDetail.premiumVehicles': 'Premium Vehicles',
    'tourDetail.vehiclesDesc': 'Hyundai & Toyota',
    'tourDetail.certifiedDriver': 'Certified Driver',
    'tourDetail.certifiedDriverDesc': 'Licensed professional',
    
    // Tour Detail Important Info
    'tourDetail.info.reservations': 'Reservations are required at least 24 hours in advance',
    'tourDetail.info.weather': 'Tours operate regardless of weather conditions',
    'tourDetail.info.flexible': 'Itinerary can be adjusted according to your preferences',
    'tourDetail.info.pickup': 'Pick-up and drop-off at your designated location',
    ...
    'about.passion': 'I have a passion for sharing the beauty, history and culture of my country with visitors from all over the world. With over 8 years of experience in premium tourism, I guarantee that each tour is a personalized and unforgettable experience.',
